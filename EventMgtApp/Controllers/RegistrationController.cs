...
using EventMgtApp.ViewModel;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.Rendering;

namespace EventMgtApp.Controllers
{
    public class RegistrationController : Controller
    {
        ...
        public RegistrationController(DataContext context /*IEmailSender emailSender*/)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create(RegistrationViewModel reg)
        {
            if (ModelState.IsValid)
            {
                ...
                var reciever = Registration.Email;
                var subject = "Event Registration Confirmation";
                var body = "Thank you for registering for the event! We look forward to seeing you there.";
